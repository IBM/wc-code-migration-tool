 ...
 */
@XmlType(name = "levelEnum", namespace = "http://www.validator.commerce.ibm.com/setup")
@XmlEnum
public enum LevelEnum {

	@XmlEnumValue("none")
	NONE("none"), @XmlEnumValue("loose")
	LOOSE("loose"), @XmlEnumValue("normal")
	NORMAL("normal"), @XmlEnumValue("strict")
	STRICT("strict");
