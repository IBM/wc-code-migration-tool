...
/**
 * ForbiddenWordsValidatorFactory can create instances of
 * {@link ForbiddenWordsValidator}. Only one instance is cached, which is not
 * configurable.
 * 
 * @author Trent Hoeppner
 */
public class ForbiddenWordsValidatorFactory extends BaseValidatorFactory {

	/**
	 * The singleton instance of the validator. This value will not be null.
	 */
	private ForbiddenWordsValidator validator = new ForbiddenWordsValidator();

	/**
	 * Constructor for this.
	 */
	public ForbiddenWordsValidatorFactory() {
		// do nothing
	}
