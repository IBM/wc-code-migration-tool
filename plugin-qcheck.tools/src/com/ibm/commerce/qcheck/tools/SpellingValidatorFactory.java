...
/**
 * SpellingValidatorFactory can create instances of {@link SpellingValidator}.
 * Only one instance is cached, which is not configurable.
 * 
 * @author Trent Hoeppner
 */
public class SpellingValidatorFactory extends BaseValidatorFactory {

	/**
	 * The singleton instance of the validator. This value will not be null.
	 */
	private SpellingValidator validator = new SpellingValidator();

	/**
	 * Constructor for this.
	 */
	public SpellingValidatorFactory() {
		// do nothing
	}
