...
/**
 * CheckStyleValidatorFactory can create instances of
 * {@link CheckStyleValidator}. Only one instance is cached, which is not
 * configurable.
 * 
 * @author Trent Hoeppner
 */
public class CheckstyleValidatorFactory extends BaseValidatorFactory {

	/**
	 * The singleton instance of the validator. This value will never be null.
	 */
	private CheckstyleValidator validator = new CheckstyleValidator();

	/**
	 * Constructor for this.
	 */
	public CheckstyleValidatorFactory() {
		// do nothing
	}
