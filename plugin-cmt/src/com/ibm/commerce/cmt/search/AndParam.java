...
/**
 * This class represents a meta-parameter that makes two other filter parameters
 * required criteria of the search.
 * 
 * @author Trent Hoeppner
 */
public class AndParam implements FilterResultParam<Object> {

	private List<Param> params;

	public AndParam(List<Param> params) {
	...
	public Node toXML(Document doc) {
		Element param = doc.createElement("and");
