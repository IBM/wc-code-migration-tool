 ...
 */
public class MethodDeclReplace implements Action {

	private String textContents;

	private List<Param> replaceParams;

	public MethodDeclReplace(String textContents, List<Param> replaceParams) {
	...
	public List<Step> getSteps(Context context) {
		...
		steps.add(new ReplaceInFileStep(visitor.replacement));
	...
	private final class ChangeVisitor extends ASTVisitor {
		...
		public boolean visit(SimpleName node) {
			replacement = replaceParam.findReplacement(context, node.getFullyQualifiedName());
