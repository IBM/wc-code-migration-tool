 ...
 */
public class MethodDeclRemove implements Action {

	public MethodDeclRemove() {
		// do nothing
	}

	@Override
	public String getName() {
		return "methodDeclRemove";
	}
	...
	private final class ChangeVisitor extends ASTVisitor {
		...
		public boolean visit(SimpleName node) {
			...
			// we remove the whole method
			int removeStart = methodDeclaration.getStartPosition();
			int removeEnd = removeStart + methodDeclaration.getLength();
